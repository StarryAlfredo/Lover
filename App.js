...
import PhonographScene from './components/PhonographScene.js';
import TypewriterScene from './components/TypewriterScene.js';
import RooftopScene from './components/RooftopScene.js';
import ScratchCardScene from './components/ScratchCardScene.js';

const App = () => {
  const [currentScene, setCurrentScene] = useState(Scene.PHONOGRAPH);
